...
// distances
export const DISTANCE_TO_SWITCH_SCENERY = 1200;
export const DISTANCE_BETWEEN_TRACKS = 25;
...
// obstacles
export const HORIZONTAL_OBSTACLE_SCALE_ARRAY = [0.06, 0.07, 0.06];
export const VERTICAL_OBSTACLE_SCALE_ARRAY = [1.8, 1.8, 1.8];
export const OBSTACLE_LEFT_POSITION_X = -25;
export const OBSTACLE_CENTER_POSITION_X = 0;
export const OBSTACLE_RIGHT_POSITION_X = 25;
